...
mod tests {
    ...
    fn test_seestern_gen_moves_center() {
        let to_one = bitboard!(0x1C0014000000);
        let to_two = bitboard!(0x14001C000000);
    ...
    fn test_seestern_gen_moves_edge() {
        let to_one = bitboard!(0x7000);
        let to_two = bitboard!(0x5000);
    ...
    fn test_seestern_gen_moves_below() {
        let to_one = bitboard!(0x3000200000000);
        let to_two = bitboard!(0x2000300000000);
    ...
    fn test_muschel_gen_moves_center() {
        let to_one = bitboard!(0x140000000000);
        let to_two = bitboard!(0x14000000);
    ...
    fn test_muschel_gen_moves_below() {
        let to_one = bitboard!(0x2000000000000);
        let to_two = bitboard!(0x200000000);
